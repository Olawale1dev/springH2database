...
public interface StudentRepository extends JpaRepository<Student, Long> {
    ...
    List<Student> getStudentFirstNameByEmailAddress (String emailId);
    ...
    List<Student> getStudentByEmailAddressNativeNamedParam (@Param("emailId") String emailId);
    ...
    Student save( String firstName, String emailId);
